...
Connection con=null;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     String sql ="Select* from database_1 where username=? and password=?";
      try{
      ...
      if(name.equals("Shubh")&&pass.equals("Shubh123")){
          JOptionPane.showMessageDialog(null,"welcome "+name,"Sucessful Login",JOptionPane.PLAIN_MESSAGE);
      }
      else{
          JOptionPane.showMessageDialog(null,"invalid user name/password","UnSucessful Login",JOptionPane.PLAIN_MESSAGE);
      }*/
